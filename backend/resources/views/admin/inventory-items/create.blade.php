@extends('admin.layout', ['title' => 'Create Inventory Item - MedLink Admin'])

@section('content')
    <div class="card">
        <h2 style="margin-top:0;">Create Inventory Item</h2>
        <div class="muted">Form sends POST /api/v1/inventory-items</div>
    ...
    <script>
        ...
        async function submitCreate() {
            ...
            try {
                ...
                const res = await fetch(apiBase + '/inventory-items', {
                    method: 'POST',
                    headers: {
